...
| Web        | Mobile           |
| ------------- | -------------:|
| <img style="width:100%;" src="https://github.com/ananthujp/greenBlog/blob/master/blog-web.png"/>       |            <img style="width:100%;" src="https://github.com/ananthujp/greenBlog/blob/master/blog-mobile.png"/>   |
|Fully responsible|
...
The website comes with a feature-rich text editor that allows users to create and edit their blog posts effortlessly. It also supports the insertion of images directly into the posts, enhancing the visual appeal of the content.
 <img style="width:50%;" src="https://github.com/ananthujp/greenBlog/blob/master/text-editor-png.png"/>
...
The website includes an internal messaging system that allows users to communicate with authors, administrators, and other blog contributors. This feature encourages collaboration and community engagement.
 <img style="width:50%;" src="https://github.com/ananthujp/greenBlog/blob/master/mails.png"/>
<h3>5. Interactive Blog Posts</h3>
<h4>Live View Count:</h4> Each blog post displays a live view count, providing authors with real-time feedback on the popularity of their content.
<h4>Reactions:</h4> Users can react to blog posts using the 'clap' option, expressing their appreciation for the content.
<h4>Comments:</h4> Users can add text and gif comments to blog posts, facilitating discussions and interactions among readers.
<img style="width:50%;" src="https://github.com/ananthujp/greenBlog/blob/master/interactive.png"/>
<h3>6. Homepage Sections</h3>
<h4>Hero Section:</h4> The homepage features a hero section highlighting popular posts based on view count, creating a visually appealing entry point for users.
<h4>Recent Posts:</h4> A section showcasing the most recent blog posts, ensuring that users stay updated with the latest content.

<h3>7. Dark/Light Modes and Color Schemes</h3>
The blog website offers a customizable user interface, allowing users to tailor their reading experience according to their preferences. This includes:

<h4>Dark/Light Modes: </h4>Users can switch between dark and light modes, enhancing readability and reducing eye strain in different lighting conditions.
<img  src="https://github.com/ananthujp/greenBlog/blob/master/colors.png"/>
<h4>Multiple Color Schemes: </h4>The platform provides a selection of 7 distinct color schemes. Users can choose from a variety of color palettes, enabling them to personalize the website's appearance to match their style and mood.

<h3>8. Author Profiles</h3>
Authors have dedicated profile pages where they can showcase their expertise and personality. They can add a bio description, profile picture, and other relevant details, allowing readers to learn more about the creators behind the content.
 <img style="width:50%;" src="https://github.com/ananthujp/greenBlog/blob/master/authors-page.png"/>
